...
export default function SigninPopup() {
  ...
  return (
    <div className="_bgimg flex-col items-center bg-cover">
      <div className="w-80 pt-4 sm:w-96 sm:pt-4">
        <Card className="bg-background rounded-none border-none shadow-none">
